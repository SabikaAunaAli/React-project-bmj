...
const Contactus = () => {
  ...
  <div class="container px-5 py-24 mx-auto ">
    ...
    <div class="lg:w-1/2 md:w-2/3 mx-auto bg-gradient-to-r from-indigo-400 from-10% via-emerald-600 via-50% to-gray-800 to-80% p-3">
      <div class="flex flex-wrap -m-2">
        <div class="p-2 w-1/2 shadow-xl">
          <div class="relative  ">
            <label for="name" class="leading-7 text-sm text-white font-semibold">Name</label>
        ...
        <div class="p-2 w-1/2 shadow-xl">
          <div class="relative">
            <label for="email" class="leading-7 text-sm text-white font-semibold">Email</label>
        ...
        <div class="p-2 w-full shadow-xl">
          <div class="relative">
            <label for="message" class="leading-7 text-sm text-white font-semibold">Message</label>
        ...
        <div class="p-2 w-full">
          <button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-800 rounded text-lg font-semibold hover:px-10">Submit</button>
        </div>
      </div>
    </div>
  </div>
