...
const TechGad = () => {
  ...
  return (
    ...
    <div className="mx-auto">
      <h1 className="text-4xl font-bold mb-6 text-center pt-24 text-white">Overall Collections</h1>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {gadgetsData.map((gadget) => (
          <div key={gadget.id} className=" p-6 rounded-lg shadow-2xl bg-yellow-100 mb-5">
            ...
            <p className="  text-black mb-3">{gadget.description}</p>
