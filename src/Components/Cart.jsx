  ...
  return (
    <div className="container mx-auto p-4">
      <div className="grid grid-cols-2 gap-4 md:grid-cols-2 sm:grid-cols-1 XXsm:grid-cols-1">
        <div>
        <h2 className="text-2xl font-semibold mb-4 mt-20 XXsm:grid-cols-1 text-white">Shopping Cart
        ...
        {cart.length === 0 ? (
            ...
            cart.map((item) => (
            <div key={item.product.id} className="border p-4 mb-4 gap-4 w-1/2 inline-block space-y-1 XXsm:grid-cols-1 bg-gray-300">
        ...
        <div className="col-span-1 mt-20">
          ...
          <div className="grid grid-cols-3 gap-4 md:grid-cols-3 sm:grid-cols-1 xsm:grid-cols-1 XXsm:grid-cols-1">
            {products.map((product) => (
              <div key={product.id} className="border border-black p-4 mb-4 bg-yellow-100 shadow-md shadow-gray-500">
