...
const Collections = () => {
  ...
  return (
    <>
    <div className="bg- bg- h-max w-screen" >
    <div className="container mx-auto my-8">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 md:grid-cols-2 lg:grid-cols-3 gap-8 sm:grid-cols-1 XXsm:grid-cols-1">
        {gadgetsData.map((gadget) => (
          <div key={gadget.id} className=" py- rounded-lg shadow-2xl bg-gray-400">
            <img src={gadget.image} alt={gadget.name} className="w-full h-48 object-cover mb-4 rounded-md " />
            <h2 className="text-xl font-bold mb-2 text px-3">{gadget.name}</h2>
            <p className="text px-3">{gadget.description}</p>
...
<section className='lg:flex md:flex-wrap w-screen'>
    <div class="text-gray-400 body-font overflow-hidden lg:1/2 lg:w-1/2 body-font">
    <div class="container px-5 py-24 mx-auto">
        <div class="lg:w-4/5 mx-auto flex flex-wrap">
        <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto shadow-lg shadow-slate-600 h-64 object-cover object-center rounded" src="https://img.freepik.com/premium-photo/cute-white-robotic-teen-mini-unit-robot-toy-3d-rendering_379823-4384.jpg"/>
    ...
    <div class="text-gray-400  body-font overflow-hidden lg:1/2 lg:w-1/2 body-font lg:pl-10 lg:py-6 mt-6 lg:mt-0  body-font md:w-full md:py-4 ">
    <div class="container px-5 py-24 mx-auto">
        <div class="lg:w-4/5 mx-auto flex flex-wrap">
        <img alt="ecommerce" class="lg:w-1/2 w-full md:w-1 lg:h-auto h-64 object-cover object-center rounded shadow-lg shadow-slate-600" src="https://plus.unsplash.com/premium_photo-1683134061306-547f5231944a?auto=format&fit=crop&q=80&w=1000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"/>
        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
