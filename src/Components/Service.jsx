...
const Services = () => {
  return (
    <div className=" bg-[#1a191995]">
      <div className="container my-14 md:my-20 mx-auto   p-8">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 gap-y-8 mx-auto ">
          {ServiceData.map((data) => (
            <div className="flex flex-col items-start sm:flex-row gap-4">
              {data.icon}
              <div>
                <h1 className="lg:text-xl text-white font-bold">{data.title}</h1>
